...
class VolsController extends AbstractController
{
    ...
    public function indexAction(EntityManagerInterface $em, VolsRepository $volRep)
    {
        ...
        return $this->render('test1.html.twig', array('piechart' => $bar, 'pie' => $pieChart));
    }
     ...
     */
    public function mobile_all_users(NormalizerInterface $normalizable, VolsRepository $volRepository)
    {
        $users = $volRepository->findAll();
